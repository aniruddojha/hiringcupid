...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Hiring Cupid</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Process flow diagram with stages and timelines.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">One stop for a Job change.</h3>
          </div>
        </div>
      ...
      <div class="container">
          ...
          <div class="col-sm-6">
            <div class="team-member">
              ...
              <ul class="list-inline social-buttons">
                ...
                <li class="list-inline-item">
                  <a href="https://www.facebook.com/aniruddhojha">
                    <i class="fab fa-facebook-f"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a href="https://www.linkedin.com/in/aniruddhojha1">
                    <i class="fab fa-linkedin-in"></i>
                  </a>
                </li>
              </ul>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <p class="large text-muted">We have an amazing journey coming to where we are today, and now feel confident that we can provide you a professional and effective solution in a timely manner.</p>
          </div>
        </div>
      </div>
    </section>
